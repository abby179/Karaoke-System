...
public class KaraokeMachine {
  ...
  private String promptAction() throws IOException {
    System.out.printf("There are %d songs available, and %d songs in the queue.  Your options are:  %n",
  ...
  public void playNext() {
    ...
    if (song == null) {
      System.out.println("Sorry there are no songs in the queue. Use choose from the menue to add some.");
    } else {
